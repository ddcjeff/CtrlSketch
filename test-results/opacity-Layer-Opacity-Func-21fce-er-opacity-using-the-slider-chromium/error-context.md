...
- Name: Layer Opacity Functionality >> should adjust layer opacity using the slider
- Location: C:\Jeff\CtrlSketch_Beta1\tests\e2e\opacity.spec.js:5:3
...
Call log:
  - waiting for locator('.ribbon-tab:has-text("View")')
    ...
    at C:\Jeff\CtrlSketch_Beta1\tests\e2e\opacity.spec.js:9:56
```
