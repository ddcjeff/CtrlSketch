...
- Name: Drawing Functionality >> should be able to draw a shape on the canvas
- Location: C:\Jeff\CtrlSketch_Beta1\tests\e2e\app.spec.js:69:3
...
Call log:
  - waiting for locator('.ribbon-tab:has-text("Home")')
    ...
    at C:\Jeff\CtrlSketch_Beta1\tests\e2e\app.spec.js:73:56
```
