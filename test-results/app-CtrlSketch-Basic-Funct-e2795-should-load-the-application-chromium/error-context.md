...
- Name: CtrlSketch Basic Functionality >> should load the application
- Location: C:\Jeff\CtrlSketch_Beta1\tests\e2e\app.spec.js:5:3
...
Locator: locator('.canvas-workspace')
Expected: visible
Received: <element(s) not found>
Call log:
  - expect.toBeVisible with timeout 5000ms
  - waiting for locator('.canvas-workspace')

    at C:\Jeff\CtrlSketch_Beta1\tests\e2e\app.spec.js:10:53
```
