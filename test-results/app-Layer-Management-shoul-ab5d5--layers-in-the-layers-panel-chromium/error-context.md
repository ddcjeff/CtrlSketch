...
- Name: Layer Management >> should display layers in the layers panel
- Location: C:\Jeff\CtrlSketch_Beta1\tests\e2e\app.spec.js:106:3
...
Call log:
  - waiting for locator('.ribbon-tab:has-text("View")')
    ...
    at C:\Jeff\CtrlSketch_Beta1\tests\e2e\app.spec.js:110:56
```
