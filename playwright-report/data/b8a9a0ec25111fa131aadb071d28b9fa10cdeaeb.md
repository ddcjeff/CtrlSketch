...
- Name: CtrlSketch Basic Functionality >> should toggle layers panel when clicking the Layers button
- Location: C:\Jeff\CtrlSketch_Beta1\tests\e2e\app.spec.js:31:3
...
Call log:
  - waiting for locator('.ribbon-tab:has-text("View")')

    at C:\Jeff\CtrlSketch_Beta1\tests\e2e\app.spec.js:35:56
```
