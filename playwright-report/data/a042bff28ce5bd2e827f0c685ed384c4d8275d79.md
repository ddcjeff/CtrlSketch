...
- Name: Layer Management >> should be able to toggle layer visibility
- Location: C:\Jeff\CtrlSketch_Beta1\tests\e2e\app.spec.js:121:3
...
Call log:
  - waiting for locator('.ribbon-tab:has-text("View")')
    ...
    at C:\Jeff\CtrlSketch_Beta1\tests\e2e\app.spec.js:125:56
```
