         ...
         <div class="flex items-center h-12">
           ...
           <div class="flex-shrink-0 flex items-center mr-4">
             <span class="text-xl font-bold">
               <span style="color: #f7A41D;">Ctrl</span><span class="text-white">Sketch</span>
             </span>
           </div>
   ...
   export default {
     ...
     methods: {
       ...
       handleMenuAction(action) {
         this.$emit('menu', { type: action.startsWith('about') || action.startsWith('docs') || action.startsWith('support') || action.startsWith('liveChat') ? 'help' : 'file', value: action });
         this.showFileMenu = false;
         this.showHelpMenu = false;
       }
     }
